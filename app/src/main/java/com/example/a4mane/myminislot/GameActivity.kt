...
class GameActivity : AppCompatActivity() {
    ...
    fun onStartButtonTapped(view: View?){
        ...
        intent.putExtra("BET_COIN","10")
        intent.putExtra("HAVE_COIN","1000")
    ...
    fun check(){
        ...
        pref.edit().putInt("HAVE_COIN",cross * intent.getIntExtra("BET_COIN",10) + intent.getIntExtra("HAVE_COIN", 10))
